...
(function () {
  ...
  function buildEmbed(entry) {
    ...
    var isPlaceholder = !url || url.indexOf("ACUITY_OWNER_ID") !== -1;
  ...
  function buildDemoScheduler(entry) {
    ...
    modalBody.innerHTML =
      '<div class="embed-placeholder demo-scheduler">' +
        ...
        '</div>' +
        '<div class="ds-services" role="group" aria-label="Lesson type">' +
          '<button type="button" class="ds-service is-active" data-svc="0"><span>Private lesson</span><span>60 min &middot; 1-on-1</span></button>' +
          '<button type="button" class="ds-service" data-svc="1"><span>Semi-private</span><span>60 min &middot; 2 players</span></button>' +
        '</div>' +
        '<div class="ds-cal">' +
        ...
        '<p class="ds-foot-hint">Preview only &mdash; set <code>embedUrl</code> in <code>config.js</code> to go live.</p>' +
      "</div>";
